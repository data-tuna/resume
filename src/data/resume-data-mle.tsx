...
export const RESUME_DATA = {
  ...
  summary: (
    <>
Machine Learning Engineer with a strong mathematical background and experience building end-to-end ML systems in Python and PyTorch. Worked on research-driven models for graph-structured data, spanning data processing, model design, training, and evaluation. Seeking Machine Learning Engineer / Data Scientist roles.    </>
  ),
  summaryPlainText:
  "Machine Learning Engineer with a strong mathematical background and experience building end-to-end ML systems in Python and PyTorch. Worked on research-driven models for graph-structured data, spanning data processing, model design, training, and evaluation. Seeking Machine Learning Engineer / Data Scientist roles. ",
