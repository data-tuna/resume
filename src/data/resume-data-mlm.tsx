...
export const RESUME_DATA = {
  ...
  summary: (
    <>
Data Scientist / Machine Learning Engineer with a strong mathematical background, specialising in modelling and forecasting complex social systems. My work focuses on extracting predictive signals from large-scale social and media networks, where interactions are not just pairwise but group-level, contextual, and time-dependent. Experienced in translating network dynamics into early indicators of emerging trends and shifts in collective behaviour.  </>
  ),
  summaryPlainText:
  "Data Scientist / Machine Learning Engineer with a strong mathematical background, specialising in modelling and forecasting complex social systems. My work focuses on extracting predictive signals from large-scale social and media networks, where interactions are not just pairwise but group-level, contextual, and time-dependent. Experienced in translating network dynamics into early indicators of emerging trends and shifts in collective behaviour. ",
  ...
  projects: [
    ...
    
    {
      ...
      description:
"Developed a novel autoregressive generative model for forecasting dynamic social and media networks with higher-order interactions (arXiv:2503.01999). Implemented in PyTorch with custom loss functions, evaluation pipelines, and memory-aware handling of sparse, time-evolving network structures.",
      link: {
