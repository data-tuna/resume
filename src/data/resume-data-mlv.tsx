...
export const RESUME_DATA = {
  ...
  summary: (
    <>
Machine Learning Engineer with a strong mathematical background, specialising in generative modelling and representation learning. Experience building PyTorch models for high-dimensional data, with methods applicable to vision and geometric learning. Seeking ML / Computer Vision Engineer roles.    </>
  ),
  summaryPlainText:
  "Machine Learning Engineer with a strong mathematical background, specialising in generative modelling and representation learning. Experience building PyTorch models for high-dimensional data, with methods applicable to vision and geometric learning. Seeking ML / Computer Vision Engineer roles. ",
  ...
  projects: [
    ...
    
    {
      ...
      description:
"Developed a novel autoregressive generative model for high-dimensional data, with emphasis on sparse representations, " +
"geometric structure, and scalable optimisation. Designed custom PyTorch training pipelines, memory-efficient sparse data handling, " +
"and evaluation frameworks applicable to large-scale perception and 3D data.",
// Developed a novel autoregressive generative model for high-dimensional structured data, with emphasis on sparse representations, 
// geometric structure, and scalable optimisation. Designed custom PyTorch training pipelines, memory-efficient sparse data handling, 
// and evaluation frameworks applicable to large-scale perception and 3D structured data.      
link: {
    ...
    //   "Developed a prototype LLM-based tax advisory system at the finals of Imperial College Business School’s AI Ventures Hackathon, designed to assess user-provided documents and provide guidance based on UK tax regulations, including implementation of a web-scraping and data pipeline to curate relevant legal sources.",    },
    {
      ...
      "Designed and oversaw the manufacture of the monorail–pod structural interface for the UK’s leading Hyperloop team, enabling stable operation at speeds up to 311 km/h. The project was recognised by SpaceX, Virgin Hyperloop One, and the Institution of Civil Engineers, and reached the SpaceX finals in Los Angeles.",
